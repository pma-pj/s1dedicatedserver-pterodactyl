...
RUN python3 /tmp/patch_run.py \
    ...
    && sed -i 's|/home/steam/steamcmd/steamcmd.sh|/home/container/steam/steamcmd/steamcmd.sh|g' /usr/local/bin/s1ds-run.sh \
    && sed -i 's|/home/container/steamcmd/steamcmd.sh|/home/container/steam/steamcmd/steamcmd.sh|g' /usr/local/bin/s1ds-run.sh \
